...
export interface MeshClient {
  ...
  tap(subject: string, opts?: TapOptions): AsyncIterable<TapEvent>;
  instancesWatch(opts?: InstancesWatchOptions): AsyncIterable<InstancesSnapshot>;
  close(): Promise<void>;
}

...
| [ADR-0057](0057-error-taxonomy-and-module.md) | Error taxonomy and dedicated `_errors` module (adds `InvalidInput`, `HandlerError`, `NotFound`, `ConnectionFailed`) | spec | feature/error-taxonomy |

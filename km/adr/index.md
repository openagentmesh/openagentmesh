...
| [ADR-0056](0056-admin-ui.md) | OAM Admin UI: agent registry browser, invocation sandbox, event feed | test (wave 1/5 done: ws listener + `oam ui` server; screens pending) | roadmap/stage-3 |

...
|-----|----------|--------|--------|
| [ADR-0001](0001-reject-json-rpc-as-internal-message-standard.md) | Reject JSON-RPC as internal message standard | implemented | |
...
| [ADR-0004](0004-schema-quality-tiers-for-mcp-intake.md) | Schema quality tiers for MCP intake | spec | |
| [ADR-0005](0005-streaming-wire-protocol.md) | Streaming wire protocol | spec | |
| [ADR-0006](0006-sla-gating-for-mcp-export.md) | SLA gating for MCP export | spec | |
| [ADR-0007](0007-use-plain-pydantic-not-pydanticai.md) | Use plain Pydantic, not PydanticAI | implemented | |
| [ADR-0008](0008-dx-first-development-strategy.md) | DX-first development strategy | implemented | |
| [ADR-0009](0009-catalog-as-sole-discovery-primitive.md) | Catalog as sole discovery primitive | implemented | |
| [ADR-0010](0010-pull-object-store-into-phase-1.md) | Pull object store into Phase 1 | spec | |
| [ADR-0011](0011-use-uv-with-ruff-and-ty.md) | Use uv with ruff and ty | implemented | |
| [ADR-0012](0012-contract-schema-a2a-compatible-with-namespace.md) | Contract schema: A2A-compatible with namespace | implemented | |
| [ADR-0013](0013-hyphenated-kv-bucket-names.md) | Hyphenated KV bucket names | implemented | |
| [ADR-0014](0014-single-key-denormalized-catalog.md) | Single-key denormalized catalog | implemented | |
| [ADR-0015](0015-prefer-path-nats-server-over-download.md) | Prefer PATH nats-server over download | implemented | |
| [ADR-0016](0016-disconnect-advisories-for-instant-failure-detection.md) | Disconnect advisories for instant failure detection | implemented | |
| [ADR-0017](0017-rebrand-to-openagentmesh.md) | Rebrand to OpenAgentMesh | implemented | |
...
| [ADR-0022](0022-local-as-async-context-manager.md) | Make `AgentMesh.local()` an async context manager for tests and demos | documented | |
| [ADR-0023](0023-llm-cost-model-and-usage-attribution.md) | LLM cost model and usage attribution | spec | |
| [ADR-0023b](0023-single-decorator-with-type-taxonomy.md) | Single `@mesh.agent` decorator with type taxonomy _(numbering conflict, to be renumbered)_ | discussion | |
| [ADR-0024](0024-streaming-or-buffered-handler-contract.md) | Streaming or buffered as a per-agent handler choice, both typed | discussion | |

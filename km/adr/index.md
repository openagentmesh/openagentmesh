...
| [ADR-0042](0042-watcher-agent-pattern.md) | Watcher agent pattern (fourth capability combination) | spec | feature/watcher-agent |
| [ADR-0043](0043-trigger-handler-pattern.md) | Trigger handler pattern (invocable, no input) | spec | feature/watcher-agent |

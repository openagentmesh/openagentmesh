...
| `observer` | read the catalog, watch events/errors/health/death notices, tail logs and read log-level config | invoke, change log levels, or publish anything on `mesh.>` |

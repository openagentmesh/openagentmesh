...
- MCP doesn't define output schemas — mesh agents calling MCP bridge tools get untyped results. Bridge should optionally accept `output_model` overrides for developer-supplied validation.
